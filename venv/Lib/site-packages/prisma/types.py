...
_User_trainingMode_OrderByInput = TypedDict(
    '_User_trainingMode_OrderByInput',
    {
...
class UserWhereInput(TypedDict, total=False):
    ...
    trainingMode: Union[_str, 'types.StringFilter']
...
class UserScalarWhereWithAggregatesInput(TypedDict, total=False):
    ...
    trainingMode: Union[_str, 'types.StringWithAggregatesFilter']
